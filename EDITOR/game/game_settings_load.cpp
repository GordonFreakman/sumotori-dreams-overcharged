...
extern char g_editorSettingsCode[0x800];
...
// FUNCTION: EDITOR 0x0040461e
SumoS32 CheckStoredGameSettings() {
  if (g_editorSettingsCode[0] != 0) {
    return ValidateEncodedGameSettings(g_editorSettingsCode, 0, 1, 0);
  }
